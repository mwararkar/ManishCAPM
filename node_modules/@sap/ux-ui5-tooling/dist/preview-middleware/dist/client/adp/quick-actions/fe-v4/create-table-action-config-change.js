...
sap.ui.define(["sap/ui/dt/OverlayRegistry", "../../dialog-factory", "../../../utils/version", "../dialog-enablement-validator", "../../api-handler", "../../utils", "../../../utils/fe-v4", "../table-quick-action-base", "../control-types", "../../../utils/core", "./utils"], function (OverlayRegistry, ____dialog_factoryjs, _____utils_versionjs, ___dialog_enablement_validatorjs, ____api_handlerjs, ____utilsjs, _____utils_fe_v4js, ___table_quick_action_basejs, ___control_typesjs, _____utils_corejs, ___utilsjs) {
  "use strict";
