...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("salesOrderServiceListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onThesalesOrderServiceListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThesalesOrderServiceListGenerated.onFilterBar().iChangeSearchField("Search Term");
